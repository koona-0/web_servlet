...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
//Controller에서 난수를 생성한 배열을 jsp로 전달 받음 
            ...
            <span class="new_join">
                <ul>
                    ...
                    <li>
                        ...
                        <!--아래 코드 name쓰면백으로감 쓸모없는데 백이 받으면 안됨 id쓰기 -->
...
//var n = "<%=ab%>";
//console.log(n);	//[3, 0, 6, 4]의 통째로 문자열로 나옴 배열이아님!!속지마 
//console.log(JSON.parse(n));	//진짜 배열로 나옴 
